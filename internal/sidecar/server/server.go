...
import (
	...
	"github.com/phoracek/passt-kubevirt-network-binding-plugin/internal/sidecar/callback"
	"github.com/phoracek/passt-kubevirt-network-binding-plugin/internal/sidecar/domain"
)
