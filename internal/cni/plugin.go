...
import (
	...
	"github.com/phoracek/passt-kubevirt-network-binding-plugin/internal/cni/netlink"
	"github.com/phoracek/passt-kubevirt-network-binding-plugin/internal/cni/netsysctl"
)
...
func CmdAdd(args *skel.CmdArgs) error {
	...
	c := NewCmd(netns, netsysctl.New(), netlink.New())
